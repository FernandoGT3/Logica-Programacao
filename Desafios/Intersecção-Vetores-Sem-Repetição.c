...
conjunto de P números inteiros. E deposita na variável C o resultado da intersecção dos 
...
int Intersecao(int ordemM, int vetorA[MMAX], int ordemN, int vetorB[NMAX],
...
int main()
{
    ...
    printf("%d", Intersecao(m, A, n, B, &p, C));
